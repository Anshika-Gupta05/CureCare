      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        ...
        >
          ...
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-primary rounded transition-all cursor-pointer ${
              speciality === "Gynecologist" ? "bg-secondary text-black" : ""
            }`}
          >
            Gynecologist
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-primary rounded transition-all cursor-pointer ${
              speciality === "Dermatologist" ? "bg-secondary text-black" : ""
            }`}
          >
            Dermatologist
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-primary rounded transition-all cursor-pointer ${
              speciality === "Pediatricians" ? "bg-secondary text-black" : ""
            }`}
          >
            Pediatricians
          </p>
          <p
            ...
            className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-primary rounded transition-all cursor-pointer ${
              speciality === "Neurologist" ? "bg-secondary text-black" : ""
            }`}
          >
            Neurologist
          </p>
